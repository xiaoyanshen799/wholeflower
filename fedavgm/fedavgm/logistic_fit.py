...
# CSV 文件路径
csv_file = "/home/xiaoyan/wholeflower/fedavgm/logs/comm_times_compre_1000.csv"
...
for _, row in df.iterrows():
    ...
    round_time = row['client_train_s'] + row["client_to_server_ms"]/1000 + row["server_to_client_ms"]/1000 # 任务完成时长
