...
class CSVFedAvg(FedAvg):
    """FedAvg with per-client timing CSV logging."""
    ...
    def configure_fit(
        ...
        # Keep both names for compatibility with different clients.
        config["config_time"] = now
        config["confit_time"] = now
        ...
        if self.csv_log_path and results:
            ...
            with open(self.csv_log_path, "a", newline="", encoding="utf-8") as f:
                ...
                for client_proxy, fit_res in results:
                    ...
                    edcode = m.get("edcode")
                    config_time = m.get("config_time", m.get("confit_time"))
