...
def main(grid: Grid, context: Context) -> None:
    ...
    strategy = FlowerTuneLlm(
        ...
        min_train_nodes=cfg.strategy.get("min_train_nodes", 1),
        min_evaluate_nodes=cfg.strategy.get("min_evaluate_nodes", 1),
        min_available_nodes=cfg.strategy.get("min_available_nodes", 1),
    )
